...
def setup(request):
    ...
    if env_name == 'dev-us':
        ...
        product_url = 'https://Storefront:Yeti2017@development-na-yeti.demandware.net/s/Yeti_US/en_US/drinkware/'
        ...
        product_url = 'https://Storefront:Yeti2017@staging-na-yeti.demandware.net/s/Yeti_US/en_US/drinkware/'
        driver.get(product_url)
        ...
        product_url = 'https://www.yeti.com/en_US/drinkware/'
        driver.get(product_url)
