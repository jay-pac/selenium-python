...
def setup(request):
    ...
    if env_name == "dev-us":
        driver.get('https://Storefront:Yeti2017@development-na-yeti.demandware.net/s/Yeti_US/en_US/home')
        cookie = {
        ...
        driver.get('https://Storefront:Yeti2017@staging-na-yeti.demandware.net/s/Yeti_US/en_US/home')
        cookie = {
        ...
        driver.get('https://www.yeti.com/en_US/home')
        cookie = {
            'domain': 'www.yeti.com',
            'httpOnly': False,
            'name': 'consent-accepted',
