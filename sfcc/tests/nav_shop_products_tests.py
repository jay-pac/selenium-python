...
class NavShopProductsTests(unittest.TestCase):
    ...
    def tests_product_hard_coolers(self):
        ...
        # shop_menu = self.driver.find_element(By.XPATH, '//a[@class="primary-nav-link-yeti"][contains(text(),"Coolers")]')
        # nav_item_hardcoolers = self.driver.find_element(By.ID, 'nav-item-desktop-hard-coolers')
